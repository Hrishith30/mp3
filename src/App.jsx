  ...
  if (showLangModal) {
    return (
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black">
        <div className="w-full max-w-xl p-6 lg:p-10 animate-in fade-in duration-500">
          <div className="text-center mb-8 lg:mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-2 italic tracking-tight">Select Language</h2>
            <p className="text-gray-500 text-sm lg:text-base">Choose your preference to explore music</p>
          </div>

          <div className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-3 gap-2 lg:gap-3 mb-10 overflow-y-auto no-scrollbar max-h-[60vh] pr-1">
            {LANGUAGES.map(lang => (
              <button
                key={lang}
          ...
          <div className="text-center">
            <span className="text-gray-600 text-[10px] lg:text-xs uppercase tracking-[0.2em] font-black">
