...
const Layout = ({ activeView, setActiveView, children }) => {
    return (
        <div className="flex flex-col h-[100dvh] w-full bg-black text-gray-200 font-sans overflow-hidden">

            {/* Middle Section: Sidebar + Content */}
            <div className="flex-1 flex overflow-hidden relative">
                {/* Sidebar (Desktop) */}
                <div className="hidden lg:block w-fit h-full shrink-0 z-20">
                ...
                <main className="flex-1 flex flex-col min-w-0 relative h-full overflow-y-auto custom-scrollbar bg-black z-0">
                    {/* Mobile Header */}
                    <div className="lg:hidden flex items-center justify-between p-4 bg-black/80 backdrop-blur-xl border-b border-white/5 sticky top-0 z-40">
            ...
            <div className="shrink-0 z-50 w-full bg-black/80 backdrop-blur-xl border-t border-white/5 pb-20 lg:pb-0">
                <PlayerBar />
            </div>
