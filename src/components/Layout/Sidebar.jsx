...
import { HomeIcon, MagnifyingGlassIcon, HeartIcon, ShareIcon } from '@heroicons/react/24/outline';
import { HomeIcon as HomeIconSolid, MagnifyingGlassIcon as MagnifyingGlassIconSolid, HeartIcon as HeartIconSolid, ShareIcon as ShareIconSolid } from '@heroicons/react/24/solid';
            ...
            <aside className="w-64 bg-white/5 backdrop-blur-[20px] border-r border-white/5 shadow-2xl hidden lg:flex flex-col p-6 z-10 shrink-0 h-full overflow-y-auto custom-scrollbar">
                ...
                <div className="mt-auto pt-4 border-t border-white/10">
                    <button
                        ...
                        className="w-full flex items-center gap-4 px-4 py-3 rounded-2xl transition-all duration-300 group text-gray-400 hover:bg-white/5 hover:text-white"
                    >
                        <ShareIcon className="w-6 h-6 transition-transform group-hover:scale-110" />
                        <span className="text-base">Sync Devices</span>
                    </button>
                </div>
            </aside>
